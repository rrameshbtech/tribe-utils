...
export const getExpenseSummary = (month = getMonthId(new Date())) => (state: ExpenseSlice): ExpenseSummary => {
...
const defaultExpenses1 = (): Record<string, Expense> => ({
  "1": {
    id: "1",
    amount: 2300.4,
...
const defaultExpenses2 = (): Record<string, Expense> => ({
  "6": {
    id: "6",
    amount: 15000,
